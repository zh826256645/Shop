...
<script type="text/javascript">
	...
	function reCode() {
		...
		image.src = "http:localhost:8888/shopBySSH/verifyCode.action?" + date.getTime();
	}
	...
	function ajaxVerifyCode() {
		...
		xhr.open("GET",
				"${pageContext.request.contextPath}/verify.action?time="
						+ new Date().getTime() + "&verifyCode=" + verifyCode, true);
		// 4.发送
		xhr.send(null);
	}
	...
	function checkRePassword() {
		...
		if (rePassword == null || rePassword == '') {
			span3.innerHTML = "<font color='red'> 请再次输入密码！！</font>"
			return false;
		}
		if (rePassword != password) {
			span3.innerHTML = "<font color='red'> 您输入的两个密码不一致！！</font>"
			return false;
		}
		return true;
	}
			...
			<div class="wrap">
				<div class="main clearfix">
					...
					<form action="register" id="registerForm" method="post"
						novalidate="novalidate" onsubmit="return true">
						<table>
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										...
										id="span1"><s:fielderror fieldName="user.username"
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										...
										onblur="checkPassword()"><span id="span2"><s:fielderror
												fieldName="user.password" style="color:red" /></span></td>
								</tr>
								<tr>
									...
									<td><input type="password" id="rePassword"
										...
										id="span3"><s:fielderror fieldName="user.rePassword"
												style="color:red" /></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200"> <s:fielderror
											fieldName="user.email" style="color:red" /></td>
								</tr>
								<tr>
									<th>姓名:</th>
								...
								<tr>
									<th>出生日期:</th>
									<td><input type="text" name="" class="text"
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											title="点击更换验证码" onclick="reCode()">
											<span id="span4"><s:fielderror fieldName="user.verifyCode" style="color:red"/></span>
									</span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
