		...
		<div class="span18 last">
				...
				<a title="" style="outline-style: none; text-decoration: none;"
					...
					<div class="zoomPad">
						<img style="opacity: 1;" title="" class="medium"
							src="<s:property value="product.image"/>">
						<div
			...
			<div class="info">
				<dl>
					<dt>亿家价:</dt>
					<dd>
						<strong>￥：<s:property value="product.shop_price" />元/份
						</strong> 参 考 价：
						<del>
							￥
			...
			<div class="action">
				<form action="${pageContext.request.contextPath}/addShopCarItem" method="post" id="carForm">
					<dl class="quantity">
						<dt>购买数量:</dt>
						<dd>
							<input name="pid" type="hidden" value="<s:property value="product.pid" />">
							<input id="quantity" name="number" value="1" maxlength="4"
