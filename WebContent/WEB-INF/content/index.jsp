...
<title>传智商城</title>
<link href="<s:url value='/css/slider.css'/>" rel="stylesheet"
	type="text/css" />
		...
		<div class="span24">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					<s:iterator var="product" value="#session.hotProducts">
						<li><a target="_blank" href="${pageContext.request.contextPath}/productPage.action?pid=<s:property value='#product.pid'/>"><img
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<!-- 					<div class="newProductAd">
						 ...
						 -->
				<ul class="tabContent" style="display: block;">
					<s:iterator var="product" value="#session.newProducts">
						<li><a target="_blank" href="${pageContext.request.contextPath}/productPage.action?pid=<s:property value='#product.pid'/>"><img
								src="${pageContext.request.contextPath}/<s:property value="#product.image"/>"
