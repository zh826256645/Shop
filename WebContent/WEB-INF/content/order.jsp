...
<div class="container cart">
		...
		<div class="span24">
					...
					<s:iterator var="item" value="order.orderItems">
						<tr>
							<td width="60">
								...
								<img src="<s:property value="#item.product.image"/>"/>
							</td>
							<td>
			...
			<form id="orderForm" action="${pageContext.request.contextPath}/paymentForOid.action" method="post">
				<div class="span24">
					<p>				<input name="oid" type="hidden" value="<s:property value="order.oid"/>"/>
						...
						<p>
							选择银行：<br/>
							<input type="radio" name="" value="ICBC-NET-B2C" checked="checked"/>工商银行
							<img src="./bank_img/icbc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="" value="BOC-NET-B2C"/>中国银行
							<img src="./bank_img/bc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="" value="ABC-NET-B2C"/>农业银行
							<img src="./bank_img/abc.bmp" align="middle"/>
							<br/>
							<input type="radio" name="" value="BOCO-NET-B2C"/>交通银行
							<img src="./bank_img/bcc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="" value="PINGANBANK-NET"/>平安银行
							<img src="./bank_img/pingan.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="" value="CCB-NET-B2C"/>建设银行
							<img src="./bank_img/ccb.bmp" align="middle"/>
							<br/>
							<input type="radio" name="" value="CEB-NET-B2C"/>光大银行
							<img src="./bank_img/guangda.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="" value="CMBCHINA-NET-B2C"/>招商银行
